...
inquirer
    ...
    },
    {
        ...
        default: "0x1a18210c20241ea7a06224246264a59add11c8358d69826e8bd51f4ba6d3be7",
    },
])
    .then((answers) => {
    ...
    function compute_starknet_address() {
        return hash.calculateContractAddressFromHash(salt, classHash, CONSTRUCTOR_CALLDATA, deployerAddress);
    }
